    	...
    	<div>
    		...
    		<div className='mainContainer'>
			    	...
			    	<div className='testControls'>
			    		...
			    		<button title="CMD + CTR + ALT + ←" onClick={this.previousChallenge.bind(this)} className='travelBtn'>Previous Challenge</button>
			    		<button title="CMD + CTR + ALT + →" onClick={this.nextChallenge.bind(this)} className='travelBtn'>Next Challenge</button>
			    		<button title="CMD + CTRL + ↳" onClick={this.testCode} className='testBtn'>Test Code</button>
				    </div>
