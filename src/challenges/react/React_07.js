...
// ---------------------------- challenge text ----------------------------
export const challengeText = `<span class = 'default'>Intro: </span>Components are the core of React. Everything in React is a component, lets create one.
<br /><br />

There are two types of components in React.
<br /><br />

<strong>Stateless Functional Component</strong>: Is a JavaScript function. Stateless Functional Component's receive data and render it, but do not manage or track changes to that data.  Stateless components are also known as dumb components.  Smart Stateful Components will be covered in later challenges.
<br /><br />

To create a Stateless Functional Component with a function, write a JavaScript function that returns either JSX or <code>null</code>. One important thing to note is that React requires your function name to begin with a capital letter. Here's an example of a stateless functional component that assigns an HTML class in JSX:
...
Because a JSX component represents HTML, you could put several components together to create a more complex HTML page.  It allows you to compose your UI from many separate, isolated components. This makes it easier to build and maintain complex user interfaces.`
